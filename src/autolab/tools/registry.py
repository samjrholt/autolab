...
class ToolRegistry:
    ...
    def _register(
        ...
        decl = ToolDeclaration(
            ...
            resource_kind=raw.get("resource", raw.get("resource_kind")),
            requires=dict(raw.get("requires", raw.get("resource_requirements", {})) or {}),
            inputs=dict(raw.get("inputs", {}) or {}),
            outputs=dict(raw.get("outputs", {}) or {}),
            adapter_path=raw.get("adapter", "dynamic"),
